...
// Disesuaikan: format angka Indonesia (id-ID) & warna mengikuti induk (inherit).
...
export function NumberTicker({
  ...
  return (
    <span ref={ref} className={`inline-block tabular-nums ${className}`} {...props}>
      {new Intl.NumberFormat("id-ID", { minimumFractionDigits: decimalPlaces, maximumFractionDigits: decimalPlaces }).format(startValue)}
    </span>
  )
}
