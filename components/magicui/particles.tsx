...
// MagicUI — Particles (https://magicui.design/docs/components/particles)
...
export const Particles: React.FC<ParticlesProps> = ({
  ...
  const drawParticles = useCallback(() => {
    ...
    for (let i = 0; i < count; i++) drawCircle(circleParams())
  ...
  useEffect(() => {
    ...
    if (rect) {
      ...
      if (inside) { mouse.current.x = x; mouse.current.y = y }
    }
